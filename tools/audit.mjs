...
const ALL = [
  ...
  ['proof','/proof'], ['graveyard','/graveyard'], ['list','/list'], ['listed','/list?id=342379'], ['gaps','/pool-gaps'], ['quest','/quest'], ['contracts','/contracts'], ['help','/help'], ['build','/build'], ['brand','/brand'], ['leash','/leash'],
];
